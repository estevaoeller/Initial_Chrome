...
export class SettingsDataManager {
    ...
    init(onQuickLinksImported) {
        ...
        if (this.importDataBtn && this.importFileInput) {
            ...
            this.importFileInput.addEventListener('change', (e) => this.importData(e, onQuickLinksImported));
        }
    ...
    exportData() {
        ...
        setTimeout(() => { this.exportDataBtn.innerHTML = originalText; }, 2000);
            ...
            try {
                ...
                if (confirm("Tem certeza que deseja importar os dados? Isso substituirá todas as configurações e atalhos atuais.")) {
                    ...
                    if (importData.quickLinks) {
                        chrome.storage.sync.set({ quickLinks: importData.quickLinks }, () => {
                    ...
                    if (importData.settings) {
                        chrome.storage.sync.set({ extensionSettings: importData.settings }, () => {
